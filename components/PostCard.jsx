...
const PostCard = ({ post }) => {
  ...
  return (
    <div className='relative bg-white bg-opacity-10 rounded-lg p-6 mb-6 text-white shadow-lg backdrop-filter backdrop-blur-sm'>
      ...
      <h1 className="text-center mb-8 cursor-pointer text-3xl font-semibold">
        <Link href={`/post/${post.slug}`} className='hover:text-pink-600 transition duration-700'>{post.title}</Link>
      </h1>
